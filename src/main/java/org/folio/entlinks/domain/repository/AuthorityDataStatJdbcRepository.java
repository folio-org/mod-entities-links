...
public class AuthorityDataStatJdbcRepository {
  ...
  public AuthorityDataStatJdbcRepository(JdbcTemplate jdbcTemplate, FolioExecutionContext folioExecutionContext) {
  ...
  public List<AuthorityDataStat> findActualByActionAndDate(AuthorityDataStatAction action,
    ...
    String sql = """
        ...
        """
        .formatted(
            getFullPath(folioExecutionContext, tenant, AUTHORITY_DATA_STAT_TABLE),
  ...
  private RowMapper<AuthorityDataStat> authorityDataStatRowMapper() {
    return (rs, rowNum) -> {
      ...
      stat.setAuthorityId(rs.getObject("authority_id", UUID.class));
