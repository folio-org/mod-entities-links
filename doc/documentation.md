...
| S3_URL                                                  | https://s3.amazonaws.com | S3 compatible service url                                                                                                                                                                            |
| S3_REGION                                               | us-west-2                | S3 compatible service region                                                                                                                                                                         |
| S3_BUCKET                                               | -                        | S3 compatible service bucket                                                                                                                                                                         |
| S3_LOCAL_SUB_PATH                                       | mod-entities-links       | S3 subpath for local files storage                                                                                                                                                                   |
