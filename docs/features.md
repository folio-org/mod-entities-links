...
| Feature                                                                                    | Description                                                                                                                                                                                                           |
|--------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Authority Heading Types Management](features/authority-heading-types-management.md)       | Provides a paginated, CQL-filterable collection endpoint for retrieving authority heading types (e.g., Personal Name, Topical Term) that classify the kind of heading an authority record carries.                    |
